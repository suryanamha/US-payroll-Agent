        ...
        <div className="max-w-7xl mx-auto">
          {!payStubData && !isLoading && (
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Enter employee details below to generate a compliant pay stub for NJ, FL, NY, IN, CA, OR, DE, DC, AL, AK, AZ, AR, GA, TX, NV, NH, SD, TN, WY, OH, PA, MI, or KY.</p>
            </div>
          )}
