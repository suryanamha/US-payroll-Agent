            ...
            <Section title="Pay Period & Earnings">
                ...
                {data.payType === 'hourly' ? (
                     <>
                        ...
                        <Input label="Overtime Rate Multiplier" id="overtimeRateMultiplier" name="overtimeRateMultiplier" type="number" min="1" step="0.1" value={data.overtimeRateMultiplier} onChange={handleChange} error={errors.overtimeRateMultiplier} info="Standard overtime is 1.5 times the regular rate. Some contracts or state laws may specify a different rate."/>
                     </>
